...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !vestingAmt.IsZero() {
				baseVestingAccount := authvesttypes.NewBaseVestingAccount(baseAccount, vestingAmt.Sort(), vestingEnd)
				...
				case vestingStart != 0 && vestingEnd != 0:
					genAccount = authvesttypes.NewContinuousVestingAccountRaw(baseVestingAccount, vestingStart)

				case vestingEnd != 0:
					genAccount = authvesttypes.NewDelayedVestingAccountRaw(baseVestingAccount)
