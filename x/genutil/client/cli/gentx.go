...
func GenTxCmd(ctx *server.Context, cdc *codec.Codec, mbm module.BasicManager, smbh stakingMsgBuildingHelpers,
	genBalIterator genutil.GenesisBalancesIterator, defaultNodeHome, defaultCLIHome string) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if info.GetType() == keyring.TypeOffline || info.GetType() == keyring.TypeMulti {
