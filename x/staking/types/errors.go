...
func ErrNoValidatorFound(codespace string, valAddr string) error {
	return sdkerror.New(codespace, CodeInvalidValidator, fmt.Sprintf("validator %s does not exist", valAddr))
}

// ErrValidatorOwnerExists returns an error when the validator address has been registered
func ErrValidatorOwnerExists(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidValidator,
...
func ErrValidatorPubKeyExists(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidValidator,
...
func ErrDescriptionLength(codespace string, descriptor string, got, max int) error {
	return sdkerror.New(codespace, CodeInvalidValidator,
...
func ErrCommissionNegative(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidValidator, "commission must be positive")
}

// ErrCommissionHuge returns an error when the commission is greater than 100%
func ErrCommissionHuge(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidValidator, "commission cannot be more than 100%")
}

// ErrCommissionGTMaxRate returns an error when the commission rate is greater than the max rate
func ErrCommissionGTMaxRate(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidValidator, "commission cannot be more than the max rate")
}

// ErrCommissionUpdateTime returns an error when the commission is remodified within 24 hours
func ErrCommissionUpdateTime(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidValidator, "commission cannot be changed more than once in 24h")
}

// ErrCommissionChangeRateNegative returns an error when the commission change rate is not positive
func ErrCommissionChangeRateNegative(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidValidator, "commission change rate must be positive")
}

// ErrCommissionChangeRateGTMaxRate returns an error when the commission change rate is greater than the max rate
func ErrCommissionChangeRateGTMaxRate(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidValidator, "commission change rate cannot be more than the max rate")
}

// ErrCommissionGTMaxChangeRate returns an error when the new rate % points change is greater than the max change rate
func ErrCommissionGTMaxChangeRate(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidValidator, "commission cannot be changed more than max change rate")
}

// ErrMinSelfDelegationInvalid returns an error when the msd isn't positive
func ErrMinSelfDelegationInvalid(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidValidator, "minimum self delegation must be a positive integer")
}
...
func ErrWrongOperationAddr(codespace string, msg string) error {
	return sdkerror.New(codespace, CodeInvalidInput, fmt.Sprintf("wrong operation address found. msg: %s", msg))
}

// ErrBadDenom returns an error when the coin denomination is invalid
func ErrBadDenom(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation, "invalid coin denomination")
}

// ErrBadDelegationAmount returns an error when the amount of delegation isn't positive
func ErrBadDelegationAmount(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation, "amount must be > 0")
}

// TODO:remove it later
// ErrInsufficientShares returns an error when the delegation shares is not enough
func ErrInsufficientShares(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation, "insufficient delegation shares")
}

// ErrNoUnbondingDelegation returns an error when the unbonding delegation doesn't exist
func ErrNoUnbondingDelegation(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation, "no unbonding delegation found")
}

// ErrAddSharesToDismission returns an error when a zero-msd validator becomes the shares adding target
func ErrAddSharesToDismission(codespace string, valAddr string) error {
	return sdkerror.New(codespace, CodeInvalidShareAdding,
...
func ErrNoAvailableValsToAddShares(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidShareAdding,
...
func ErrDelegatorNotAProxy(codespace string, delegator string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
...
func ErrNeverProxied(codespace string, delegator string) error {
	return sdkerror.New(codespace, CodeInvalidProxy,
...
func ErrAlreadyProxied(codespace string, delegator string) error {
	return sdkerror.New(codespace, CodeInvalidProxy,
...
func ErrAddSharesDuringProxy(codespace string, delegator string, proxy string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
...
func ErrDoubleProxy(codespace string, delegator string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
...
func ErrNotFoundProxy(codespace string, delegator string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
		fmt.Sprintf("failed. no proxy with %s", delegator))
}

// ErrInvalidDelegation returns an error when the delegation is invalid
func ErrInvalidDelegation(codespace string, delegator string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
...
func ErrNilValidatorAddrs(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidInput,
...
func ErrExceedValidatorAddrs(codespace string, num int) error {
	return sdkerror.New(codespace, CodeInvalidInput,
...
func ErrNoDelegationToAddShares(codespace string, delegator string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
...
func ErrNotInDelegating(codespace string, addr string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
...
func ErrInsufficientDelegation(codespace string, quantity, delLeft string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
...
func ErrInsufficientQuantity(codespace string, quantity, minLimit string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
...
func ErrMoreMinSelfDelegation(codespace string, valAddr string) error {
	return sdkerror.New(codespace, CodeInvalidMinSelfDelegation,
...
func ErrNoMinSelfDelegation(codespace string, valAddr string) error {
	return sdkerror.New(codespace, CodeInvalidMinSelfDelegation,
...
func ErrBadUnDelegationAmount(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
...
func ErrInvalidProxyUpdating(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidProxy,
...
func ErrAlreadyAddedShares(codespace string, delAddr string) error {
	return sdkerror.New(codespace, CodeInvalidProxy,
...
func ErrNoDelegatorExisted(codespace string, delAddr string) error {
	return sdkerror.New(codespace, CodeInvalidDelegation,
...
func ErrTargetValsDuplicate(codespace string) error {
	return sdkerror.New(codespace, CodeInvalidShareAdding,
...
func ErrAlreadyBound(codespace string, delAddr string) error {
	return sdkerror.New(codespace, CodeInvalidProxy,
